#${micro}_summed_pop in format <pop> <sum> where sum is the sum of the pvalues of SNPs with the strongest evidence of positive selection (done individually for each micronutrient category)
